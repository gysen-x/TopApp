...
import stls from './StarIcon.module.css'
...
export const StarIcon = ({ className, ...props }: IStarIconProps) => {
	...
	return (
		<div title='Like' className={cn(className, stls.heartContainer)} {...props}>
			<label className={stls.container}>
				<input
					type='checkbox'
					checked={checked}
